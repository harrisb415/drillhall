...
**Status: v1.15.0 — Phases 1–5 complete**, plus the exam simulator addendum (see `comptia-platform-build-spec.md` §13 for the phase plan and [CHANGELOG.md](CHANGELOG.md) for release history). Four cert packs shipped: A+ Core 1 (220-1201), A+ Core 2 (220-1202), Network+ (N10-009), Security+ (SY0-701).
...
Novelty is bounded by pool size — two exams of N questions from a bank of B must share at least `2N − B`. With 250+ questions per cert (Core 1 at 467), **every mode currently has zero forced repeat**, including a back-to-back pair of full 90-question mocks. The PBQ gauntlet is deliberately capped at half the PBQ pool for the same reason, since performance-based questions are the most expensive to author.

| Cert | Questions | of which PBQ | of which multi-response | Full mock forced repeat |
|---|---|---|---|---|
| A+ Core 1 (220-1201) | 467 | 15 | 66 | 0% |
| A+ Core 2 (220-1202) | 252 | 20 | 28 | 0% |
| Network+ (N10-009) | 271 | 12 | 30 | 0% |
| Security+ (SY0-701) | 279 | 12 | 31 | 0% |
